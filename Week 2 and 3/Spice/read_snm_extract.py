...
# CONFIG
# ----------------------------------------------------------------------
DC1_FILE = 'dc1_data.txt'
DC2_FILE = 'dc2_data.txt'
VDD = 1.8
...
def main():
    ...
    print(f"Read SNM (worst-case, reported value): "
    ...
    plt.tight_layout()
    plt.savefig('wave_read_snm.png', dpi=150)
    print("\nPlot saved to wave_read_snm.png")
